...
class AppConfigUI {
  AppConfigUI._(); // isso é um construtor privado, nao é possivel instanciar essa classe com esse código

  static const MaterialColor primarySwatch = MaterialColor(0XFF0066B0, {
    50: Color(0XFF005c9e),
